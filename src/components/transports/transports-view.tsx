        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {vehicles.map((vehicle, idx) => (
            <motion.div
              ...
              className="flex"
            >
              <Card className="rounded-[2rem] border-border/50 bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 flex flex-col w-full group">
                {/* Image Section — clickable to detail */}
                ...
                <CardContent className="p-6 flex-1 flex flex-col space-y-4">
                  <div className="space-y-1">
                    <Link href={`/transporte/${vehicle.id}`} className="block">
                      <h3 className="text-2xl font-bold text-foreground group-hover:text-ocean transition-colors">
                        {vehicle.name}
                      </h3>
                    </Link>
                  ...
                  <div className="space-y-4 pt-1">
                    ...
                    <div className="flex gap-2">
                      <Button
                        asChild
                        variant="outline"
                        className="flex-1 h-11 rounded-xl border-border text-foreground hover:bg-muted font-semibold text-xs"
                      >
                        <Link href={`/transporte/${vehicle.id}`}>
                          Ver detalles
                      ...
                      <Button
                        ...
                        className="flex-1 relative flex items-center justify-center gap-2 h-11 rounded-xl bg-[#1DA851] hover:bg-[#199346] text-white font-bold text-xs shadow-sm transition-all"
                      >
