                ...
                <CardContent className="p-6 flex-1 flex flex-col space-y-4">
                  ...
                  <div className="space-y-4 pt-1">
                    ...
                    <Button
                      ...
                      className="w-full relative flex items-center justify-center gap-2 h-12 rounded-xl bg-[#1DA851] hover:bg-[#199346] text-white font-bold text-sm shadow-sm transition-all"
                    >
