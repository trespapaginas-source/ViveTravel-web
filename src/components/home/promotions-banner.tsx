  ...
  return (
    <section className="pt-6 pb-2 md:py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative group rounded-3xl overflow-hidden shadow-md border border-zinc-200 aspect-[2.5/1] bg-zinc-50">
          {/* Slides */}
        ...
        <div className="hidden md:block relative z-20 -mt-10 max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            {/* Card 1 */}
            <div className="bg-white p-4 rounded-2xl border border-zinc-200/80 shadow-md flex items-center gap-3.5 hover:border-zinc-300 transition-all duration-200">
              <div className="p-2 bg-indigo-50 rounded-xl text-indigo-600 shrink-0 flex items-center justify-center">
                <svg className="w-6 h-6 text-indigo-600 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-left min-w-0">
                <h3 className="font-bold text-zinc-800 text-sm md:text-base leading-tight mb-0.5 truncate">
            ...
            <a 
              ...
              className="bg-white p-4 rounded-2xl border border-zinc-200/80 shadow-md flex items-center gap-3.5 hover:border-zinc-300 transition-all duration-200 group text-left cursor-pointer"
            >
              <div className="p-2 bg-indigo-50 rounded-xl text-indigo-600 shrink-0 group-hover:bg-indigo-100 transition-colors flex items-center justify-center">
                <svg className="w-6 h-6 text-indigo-600 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-left min-w-0 flex-1">
                <h3 className="font-bold text-zinc-800 text-sm md:text-base leading-tight mb-0.5 truncate group-hover:text-indigo-600 transition-colors font-medium">
