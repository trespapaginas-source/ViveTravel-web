export interface TourPlan {
  ...
  /** Confirmed departure windows (ISO "YYYY-MM-DD" start/end) for
   * fixedDeparture plans. Empty/omitted until real dates are provided — the
   * UI falls back to a WhatsApp prompt rather than showing invented dates.
...
export const testimonials: Testimonial[] = [
  {
    ...
    avatar: "JR",
    avatarBg: "#1a73e8",
    avatarUrl: "https://lh3.googleusercontent.com/a-/ALV-UjWxXIHtaibmDl9HOOV1Go3lec2q3rUL3MMJP3-RyDnAhGI4UWEJ=w96-h96-p-rp-mo-br100",
    location: "Hace 1 semana",
    text: "Es la mejor agencia, excelente servicio, cumplidos y te brindan la mejor experiencia. Repetiría con ellos mil veces y mil viajes.",
    rating: 5,
    tripName: "Opinión de Google"
  },
  {
    id: "rev-dennys",
    name: "dennys margarita fernandez sacramento",
    avatar: "DF",
    avatarBg: "#0f9d58",
    avatarUrl: "https://lh3.googleusercontent.com/a/ACg8ocKIyE_FexeuvpGUi2aISEvQVMRT5YAT38DKKvatyCcX61NLeA=w96-h96-p-rp-mo-br100",
    location: "Hace 2 semanas",
    text: "Fue una experiencia sin límites! , súper espectacular! . Yo volvería a vivir esta maravillosa experiencia con Vive Travel",
    rating: 5,
    tripName: "Opinión de Google"
  },
  {
    id: "rev-jennifer",
    name: "Jennifer Paola Olivares Rojas",
    avatar: "JO",
    avatarBg: "#f4b400",
    avatarUrl: "https://lh3.googleusercontent.com/a-/ALV-UjUwZwEqZ2HIvOZL7ipnunDiW7AWiBuOF9CcET4sYvQMRPyXCIP3Jw=w96-h96-p-rp-mo-br100",
    location: "Hace 2 semanas",
    text: "Maravillosa experiencia! Vive travel, la mejor opción para vivir experiencias inolvidables!!",
    rating: 5,
    tripName: "Opinión de Google"
  }
];
