...
export const siteContent: SiteContentData = {
    ...
    "benefits": [
      {
        ...
        "description": "Elige tus destinos, actividades y ritmo de viaje. Tú decides cómo vivir el Atlántico."
      },
      {
        "title": "Expertos locales",
        "description": "Nuestros guías conocen cada rincón del departamento y te llevan a lugares únicos."
      },
      {
        "title": "Mejores precios",
        "description": "Sin intermediarios. Armamos tu viaje a medida con tarifas directas y transparentes."
      }
    ],
    ...
    "cancellationPolicies": [
      {
        ...
        "content": "- **Más de 15 días antes del viaje:** Reembolso del 90% del valor pagado (se retiene 10% por gastos administrativos).\n- **8 a 15 días antes:** Reembolso del 50% del valor pagado.\n- **3 a 7 días antes:** Reembolso del 30% del valor pagado.\n- **Menos de 3 días antes:** No hay derecho a devolución."
      }
    ]
  },
  "footer": {
  ...
  "campaign": {
    "active": false,
    "bannerText": "🎉 ¡Descuento de activo!",
    "ctaText": "Ver Planes",
    "ctaUrl": "#"
  },
  "seo": {
